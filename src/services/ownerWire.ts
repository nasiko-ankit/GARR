...
/**
 * Projects the internal camelCase EntityOwner (postgres.camel DB row) to
 * the snake_case wire format used by every read API response.
 * Used by register, owners, search, and manifest routes.
 */
